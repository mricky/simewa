<?php namespace App\Http\Controllers;
	...
	class AdminPackagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Satuan','name'=>'uom_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'uom,name'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Asset Id","name"=>"asset_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"asset,id"];
			//$this->form[] = ["label"=>"Uom Id","name"=>"uom_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"uom,name"];
